    ...
    <div className={styles.ProductModalContainer}>
         ...
         <button className={styles.butClose} onClick={closeModal }><img  src={close} alt="" /></button>
            ...
            <Carousel>
                ...
                <div>
                    <img src="	https://f.bonee.net/images/77c9082b-3f0e-4a9e-8e32-65436b8aea15_3.webp" />
                </div>
                  ...
                  <div className={styles.prDiv}><div style={{display:'flex',justifyContent: 'space-between'}}><p className={styles.pName}>{data.name}  </p><div style={{marginRight:'30px'}}> <Share/></div></div>   <p >Code  {data.code}</p> <p>TYPE</p><div></div>
            
              
              <div className={styles.classicDiv}>
               <NavLink exact='true' className={({ isActive }) => (isActive ? styles.active : styles.active1 )} to ='/productPizzasModal1'> <div className={ styles.classicDiv1} >PAN</div></NavLink>  
               <NavLink  to='/productPizzasModal1'>  <div className={ styles.classicDiv1} >CLASSIC</div></NavLink>
            <NavLink to='/productCheesyModal'>     <div className={ styles.classicDiv1} >CHEESY CRUST</div></NavLink>
              <NavLink to ='productPizzasModal'>  <div className={ styles.classicDiv1} >CHEESY BITES</div></NavLink> 
              </div>
...
export default ProductCheesyModal;
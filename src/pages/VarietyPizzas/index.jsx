...
import styles from './VarietyPizzas.module.css'
...
import ProductPizzaModal from '../../components/ProductPizzaModal'


const VarietyPizzas = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>PIZZAS</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'pizza').map(product => 
...
<img src= {product.picture} alt="1" onClick={()=> toggleItem(product)} />
 ...
 <div className={styles.butNer} >
           ...
           <div className={click? styles.infoDiv1:styles.infoDiv}>{product.information}</div>
            </div>
           ...
           {visible === true && data !== null && (
              ...
              <ProductPizzaModal data={data} plus={plus} minus={minus} closeModal={() => toggleItem()} />

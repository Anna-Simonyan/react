...
import styles from './VarietyBoxers.module.css'
...
const VarietyBoxers = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>BOXERS</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'box').map(product => 

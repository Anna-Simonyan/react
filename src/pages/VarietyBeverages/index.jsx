...
import styles from './VarietyBeverages.module.css'
...
const VarietyBeverages = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>BEVERAGES</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'beverage').map(product => 
...
export default VarietyBeverages;

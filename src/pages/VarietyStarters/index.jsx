...
import styles from './VarietyStarters.module.css'
...
const VarietyStarters = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>STARTERS
</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'starters').map(product => 
...
export default VarietyStarters;
...
import styles from './VarietySandwiches.module.css'
...
const VarietySandwiches = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>SANDWICHES AND ROLLS</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'sandwich').map(product => 
...
export default VarietySandwiches;
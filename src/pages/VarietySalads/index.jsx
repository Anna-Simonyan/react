...
import styles from './VarietySalads.module.css'
...
const VarietySalads = ({ id, picture, name, price }) => {
...
<div className={styles.pizzas}>SALADS</div>

<div className={click ? styles.pizzasContainer:styles.pizzasContainerColumn} >
{products.filter(product => product.type === 'Salad').map(product => 
